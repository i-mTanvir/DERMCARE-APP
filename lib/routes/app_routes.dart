...
class AppRoutes {
  static final GoRouter router = GoRouter(
    ...
    redirect: (context, state) {
      ...
      final role =
          (user?.userMetadata?['role'] ?? 'patient').toString().toLowerCase();
      final isDoctor = role == 'doctor';

      final publicRoutes = ['/', '/welcome', '/login', '/signup'];
      final isPublicRoute = publicRoutes.contains(location);
      final isDoctorPortalRoute = location == '/doctor/home' ||
          location == '/doctor/bookings' ||
      ...
      if (isLoggedIn && !isDoctor && isDoctorPortalRoute) {
        return '/home';
      }
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (_, __) => const DoctorBookingsScreen()),
      GoRoute(
          path: '/doctor/profile',
